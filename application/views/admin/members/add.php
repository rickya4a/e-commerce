    ...
    <div class="inner_1"><div class="inner_2"><div class="inner_3"><div class="inner_4 clearfix">
                    ...
                    <div class="row addedit_content">
                        ...
                        <fieldset>
                            ...
                            <div class="row form clearfix">
                                <div class="label"><span class="required_mark">*</span><label for="post_ttl">Konfirmasi Password</label></div>
                                <div class="input full">
                                    <div class="input text required">
                            ...
                            <div class="row form clearfix">
                                <div class="label"><label for="post_ttl">Telepo</label></div>
                                <div class="input full">
                                    <div class="input text required">
