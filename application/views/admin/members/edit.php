...
<div id="article">
    <h2 class="page_title">Perbarui Member</h2>
    ...
    <div class="inner_1"><div class="inner_2"><div class="inner_3"><div class="inner_4 clearfix">
                    ...
                    <div class="row addedit_content">
                        <?php echo form_open_multipart('admin/members/edit'); ?>
                        <?php echo form_hidden('id', $user['id']); ?>
                        <fieldset>
                            <div class="row form clearfix">
                                <div class="label"><span class="required_mark">*</span><label for="post_ttl">Nama Lengkap</label></div>
                            ...
                            <div class="row form clearfix">
                                ...
                                <div class="input full">
                                    <div class="input text required">
                                        <?php echo form_password(array('name' => 'password')); ?><br/>Jangan diisi jika Anda tidak ingin mengubah password
                                        <div class="error-message"><?php echo form_error('password'); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="row form clearfix">
                                <div class="label"><label for="post_ttl">Konfirmasi Password</label></div>
                                <div class="input full">
                                    <div class="input text required">
                            ...
                            <div class="row form clearfix">
                                <div class="label"><label for="post_ttl">Telepon</label></div>
                                <div class="input full">
                                    <div class="input text required">
                            ...
                            <div class="row form clearfix">
                                <div class="label"><label for="post_ttl">Alamat</label></div>
                                <div class="input full">
