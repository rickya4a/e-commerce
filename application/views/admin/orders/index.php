...
<h2 class="page_title">Laporan Pemesanan</h2>
...
while($row = mysql_fetch_array($result)){
    ...
    echo "<h2>Total  Ekspetasi Keuntungan ". " = RP. ". $total;    echo "</h2>";
}
?>
            ...
            <?php foreach ($orders as $order): ?>
                <tr>
                    ...
                    <td>
                        ...
                        |
                        <a href="<?php echo site_url('admin/orders/delete/' . $order['id']) ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus?');">Hapus</a>
                    </td>
                </tr>
